...
const ServicesBar = () => {
  useEffect(() => {
    if (typeof window !== 'undefined') {
      // AOS.init only in the client-side environment
      AOS.init({
  ...
  return (
    <div className="bg-gradient-to-r from-gray-900 via-indigo-900 to-gray-900 min-h-screen flex items-center justify-center">
      {/* Ensure full height, gradient background, and center content */}
      <section className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        ...
        >
          <img 
            ...
            alt="services"
            src="https://wac-cdn.atlassian.com/dam/jcr:e40a81ed-cc02-472d-a62b-f5b2d21d11ef/tips-and-tricks-wide.png?cdnVersion=2283"
            // Replace with a service-related image URL
          />
        </div>
        <div 
