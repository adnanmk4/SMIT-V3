        ...
        return (
            <div className="container mx-auto px-4 py-10">
                ...
                <section className="my-10">
                    <h2 className="text-3xl sm:text-4xl font-semibold text-center text-gray-800 mb-6">Skills & Technologies</h2>
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-6">
                        {skills.map(({ skill, icon }) => (
                            <div key={skill} className="bg-white p-4 rounded-lg shadow-lg flex flex-col items-center justify-center transition-transform duration-300 hover:scale-105 relative">
                                ...
                                <h3 className="font-semibold text-base sm:text-lg text-gray-800 text-center">{skill}</h3>
